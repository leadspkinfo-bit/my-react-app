        ...
        <div className="hero-text-area">
          ...
          <div className="hero-scroll-content">
            ...
            <div className="hero-stats">
              <div className="stat-item"><h2><Counter end={50} duration={2000} />+</h2><p>Engineers</p></div>
              <div className="stat-divider"></div>
              <div className="stat-item"><h2><Counter end={1000} duration={2000} />K+</h2><p>Projects</p></div>
              <div className="stat-divider"></div>
              <div className="stat-item"><h2><Counter end={5} duration={2000} />+</h2><p>Countries</p></div>
            </div>
          </div>
        </div>
